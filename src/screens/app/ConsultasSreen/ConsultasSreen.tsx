...
export function ConsultasSreen({
  navigation,
}: AppTabScreenProps<'ConsultasSreen'>) {
  return (
    <Screen>
     ...
     <Box flexDirection='row' mt='s16' >
        <Box width={5} height={50} backgroundColor="primary">

        </Box>
        <Box justifyContent='center' flexDirection='row'  backgroundColor="grayWhite" gap='s12'>
     ...
     <Box borderRadius="s16" mt='s12'>
        ...
        <Box width={7} borderTopLeftRadius='s8' borderBottomLeftRadius='s8' height={'auto'} backgroundColor="primary">
